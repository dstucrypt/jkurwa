...
describe("API", () => {
  ...
  describe("pkey()", () => {
    ...
    it("should create private key from u8 BE buffer through jk.pkey()", () => {
      const buffer = [
        10, 14, 20, 0, 0, 30, 9, 27, 22, 1, 1, 21, 15, 27, 30, 15, 29, 20, 19,
        14, 28, 11, 7, 1, 29, 18, 10, 4, 18, 12, 4, 29
      ];
    ...
    it("should create private key from u32 LE buffer through jk.pkey()", () => {
      const buffer = [
        0x120c041d, 0x1d120a04, 0x1c0b0701, 0x1d14130e, 0x0f1b1e0f, 0x16010115,
        0x001e091b, 0x0a0e1400
      ];
  ...
  describe("pubkey()", () => {
    ...
    it("should create public key from u8 BE buffer through jk.pubkey()", () => {
      const pub = jk.pubkey(
        "DSTU_PB_257",
        [
          229, 75, 243, 249, 42, 40, 29, 2, 244, 106, 213, 99, 115, 135, 168,
          241, 60, 150, 152, 129, 108, 180, 248, 190, 173, 252, 5, 101, 250, 99,
          214, 177
        ],
        "buf8"
      );
    ...
    it("should create public key from u32 LE buffer through jk.pubkey()", () => {
      const pub = jk.pubkey(
        "DSTU_PB_257",
        [
          0xfa63d6b1, 0xadfc0565, 0x6cb4f8be, 0x3c969881, 0x7387a8f1,
          0xf46ad563, 0x2a281d02, 0xe54bf3f9
        ],
        "buf32"
      );
      assert.equal(pub.type, "Pub");
