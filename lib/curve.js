...
var Curve = function (params, param_b, m, ks, base, order, kofactor) {
    ...
    this.order = H(params.order);
    this.kofactor = params.kofactor;
    this.param_a = H(params.a);
    this.param_b = H(params.b);
    ...
    this.mod_bits = [this.m].concat(this.ks);
    ...
    if (params.base.x === undefined) {
        params.base = this.expand(H(params.base));
    } else {
...
Curve.prototype.rand = function () {
    ...
    rand8 = global.crypto.getRandomValues(rand8);
