...
var Point = function (p_curve, p_x, p_y) {
    var zero = ZERO,
        ...
        expand = function (val) {
            ...
            val = val._is_field ? val : new Field(val, 'bn', p_curve);
            ...
            cached = p_curve.expand_cache[val.toString()];
            if (cached !== undefined) {
                return cached;
            }
...
var Curve = function (params, param_b, m, ks, base, order, kofactor) {
    ...
    var ob,
        ...
        trace = function (value) {
            return new Field(value, 'bn', this).trace();
        },
        rand = function () {
    ...
    ob.order = new Field(ob.order, 'bn', ob);
