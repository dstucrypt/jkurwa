...
var jk = require('../curve'),
    bn = require('bn.js'),
    util = require('../util'),
    random = require('../rand'),
    pem = require('../util/pem'),
    b64_encode = require('../util/base64').b64_encode,
    dstszi2010 = require('../spec/dstszi2010'),
    pbes2 = require('../spec/pbes'),
    pfx = require('../spec/pfx'),
    keystore = require('../spec/keystore'),
    ks = require('../spec/keystore'),
