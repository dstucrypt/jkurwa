...
Priv.prototype.sharedKey = function(pubkey, ukm, kdf) {
  ...
  kek_input = Buffer.alloc(zz.length + counter.length + salt.length);
  zz.copy(kek_input);
...
export default Priv;
Priv.from_asn1 = from_asn1;
Priv.from_pem = from_pem;
Priv.detect_format = detect_format;
Priv.from_protected = from_protected;
Priv.sign_serialise = sign_serialise;

export { detect_format, from_asn1, from_pem, from_protected, sign_serialise };
