...
var attr_parse = function (attr) {
    ...
    curve = new jk.Curve({
        ...
        a: [dstu.curve.param_a],
        b: util.BIG_BE(dstu.curve.param_b),
        order: util.BIG_BE(dstu.curve.order.toArray()),
        kofactor: [4],
...
var Priv = function (p_curve, param_d) {
    var ob,
        ...
        pub_match = function(pub_key) {
            ...
            var my_key = this.pub_compress();
            console.log("my " + my_key.toString());
            console.log("check " + check_key.toString());

            console.log("eq " + check_key.equals(my_key));
            return check_key.equals(my_key);
        },
