...
/* The signing nonce is padded to constant bit length by Curve.pad_scalar(),
 * called in help_sign(). See docs/timing-countermeasure.md for rationale. */
...
class Priv {
  ...
  help_sign(hash_v, rand_e) {
    // Pad the nonce to constant bit length against Minerva/TPM-FAIL timing
    // side-channel attacks (see docs/timing-countermeasure.md).
