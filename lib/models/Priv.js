...
var Priv = function (p_curve, param_d) {
    var ob,
        help_sign = function (hash_v, rand_e) {
            ...
            hash_field = new jk.Field(hash_v, 'bn', p_curve);
            ...
            r = new Big(r.buf8());
            big_d = new Big(param_d.buf8());
            big_rand_e = new Big(rand_e.buf8());
            big_order = new Big(p_curve.order.buf8());
            s = big_d.multiply(r).mod(big_order);
