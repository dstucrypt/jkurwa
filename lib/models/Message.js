...
var lookupCert = function (nameSerial, possible) {
    return possible[0];
};

var Message = function (asn1_ob) {
    var ob, parse, verify, decrypt, signer, as_asn1, as_transport, mhash,
    ...
    decrypt = function(crypter, algo) {
        ...
        if (ri.value.originator.type === 'issuerAndSerialNumber') {
            pubkey = lookupCert(ri.value.originator.type, [this.help_cert]).pubkey;
        }
