...
Pub.prototype.help_verify = function(hash_val, s, r) {
  ...
  hash_val = hash_val._is_field
    ? hash_val
    : new Field(hash_val, "bn", this.curve);
...
Pub.detect_format = detect_format;
Pub.parse_sign = parse_sign;

export default Pub;
export { Pub, detect_format, parse_sign };
