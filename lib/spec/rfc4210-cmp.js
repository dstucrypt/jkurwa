var asn1 = require('asn1.js'),
    rfc3280 = require('./lib/spec/rfc3280.js');
...
var GeneralName = asn1.define('GeneralName', function() {
    this.choice({
        ...
        rfc822Name: this.implicit(1).use(IA5String),
        dNSName: this.implicit(2).use(IA5String),
        x400Address: this.implicit(3).use(ORAddress),
        directoryName: this.implicit(4).use(rfc3280.Name),
        ediPartyName: this.implicit(5).use(EDIPartyName),
        uniformResourceIdentifier: this.implicit(6).use(IA5String),
...
var CertTemplate = asn1.define('CertTemplate', function() {
    this.seq().obj(
        this.key('version').implicit(0).use(rfc3280.Version),
