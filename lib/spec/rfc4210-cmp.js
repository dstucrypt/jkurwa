...
var PKIHeader = asn1.define("PKIHeader", function() {
  this.seq().obj(
    ...
    this.key("freeText")
      ...
      .implicit(7)
      .use(PKIFreeText),
    this.key("generalInfo")
      .optional()
      .implicit(8)
      .seqof(InfoTypeAndValue)
  );
});
/* CRMF 
...
var PKIStatusInfo = asn1.define("PKIStatusInfo", function() {
  this.seq().obj(
    ...
    this.key("statusString")
      .use(PKIFreeText)
      .optional(),
    this.key("failInfo")
      .optional()
      .any() //XXX PKIFailureInfo
  );
});
