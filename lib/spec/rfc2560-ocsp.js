...
import * as rfc4210 from "./rfc4210-cmp.js";

/*
 * ASN.1 schema for the Online Certificate Status Protocol (OCSP), RFC 2560.
 *
 * OCSP lets a client ask a responder whether a specific certificate is still
 * valid ("good"), "revoked" or "unknown", as a lighter-weight alternative to
 * downloading a full CRL. This module models both the request side
 * (OCSPRequest / TBSRequest / CertID) and the response side (OCSPResponse /
 * BasicOCSPResponse / SingleResponse). In this Ukrainian DSTU 4145 stack the
 * hash algorithm carried in CertID/AlgorithmIdentifier is typically the
 * GOST 34.311 hash rather than SHA-1.
 */
...
// KeyHash: SHA-1 (or DSTU hash) of the responder's public key, used when the
// responder identifies itself byKey rather than byName.
