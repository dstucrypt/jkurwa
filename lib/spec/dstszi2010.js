...
var SignedData = asn1.define('SignedData', function() {
    this.seq().obj(
        ...
        this.key('certificate').optional().implicit(0).use(rfc3280.Certificate),
...
var sbox0c = new Buffer('a9d6eb45f13c708280c4967b231f5eadf658eba4c037291d38d96bf025ca4e17f8e9720dc615b43a28975f0bc1dea36438b564ea2c179fd0123e6db8fac57904', 'hex');

module.exports.DEFAULT_SBOX_COMPRESSED = sbox0c;
