...
module.exports.PKCS7_CONTENT_TYPES = PKCS7_CONTENT_TYPES;
...
var GOST28147Parameters = asn1.define("GOST28147Parameters", function() {
  this.seq().obj(this.key("iv").octstr(), this.key("dke").octstr());
});
...
module.exports.IssuerAndSerialNumber = IssuerAndSerialNumber;
