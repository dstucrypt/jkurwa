...
var _shiftRight = function(_bytes, _right, inplace) {
    var wright = Math.floor(_right / 32),
        right = _right % 32,
...
var lShiftXor = function(b, _ls, r) {
    var wls = _ls >> 5,
        ls = _ls % 32,
        i, l = b.length + wls + 1,
        rs = 32 - ls,
